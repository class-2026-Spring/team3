    ...
    <>
      ...
      {session && profile && (
        <div className="p-4 border-t border-gray-100">
          <div onClick={() => setShowEditModal(true)} className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors group">
            <div className="relative">
              <img
                src={profile.avatar_url?.startsWith('http') ? profile.avatar_url : `/avatars/${profile.avatar_url}`}
                alt="Avatar"
                className="w-10 h-10 rounded-full object-cover border-[2.5px] border-teal-100/60 bg-gray-100"
              />
