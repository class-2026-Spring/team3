  ...
  return (
    <header className="bg-white border-b border-gray-100 px-6 h-14 flex items-center justify-between z-10 relative">
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <p className="text-sm font-bold text-gray-900 leading-none tracking-tight">EV</p>
        </div>
      </div>
      <div className="flex items-center gap-1.5">
        ...
        <p className="text-xs text-gray-500 font-medium">총 충전소 수: <span className="text-blue-600 font-bold">{totalCount}</span>대</p>
      </div>
    </header>
  );
}
