        ...
        <header className="flex justify-between items-center py-2 px-2 relative z-10 text-white mb-6 pl-4 md:pl-2">
          <div>
            <div className="text-[11px] font-medium text-white/80 mb-0.5 flex items-center gap-1.5">
              <span className="opacity-80">Pages</span> <span className="opacity-60">/</span> <span className="font-bold opacity-100 text-white">{title}</span>
            </div>
          ...
          <div className="flex items-center gap-5">
            <div className="relative hidden md:block">
              ...
              <svg className="w-3.5 h-3.5 text-gray-500 absolute left-3.5 top-1/2 -translate-y-1/2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>

            <div className="flex items-center gap-1.5 text-white font-bold text-xs cursor-pointer hover:opacity-80 transition-opacity">
