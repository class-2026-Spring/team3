export const DICEBEAR_OPTIONS = {
  ...
  earrings: [
    "none", "variant06", "variant01", "variant02", "variant03", "variant04", "variant05"
  ],
  features: [
    "none", "mustache", "blush", "birthmark", "freckles"
  ],
  skinColor: [
    "f2d3b1", "ecad80", "9e5622", "763900"
  ],
  hairColor: [
    "ac6511", "cb6820", "ab2a18", "e5d7a3", "b9a05f", "796a45", "6a4e35", "562306", "0e0e0e", "afafaf", "3eac2c", "85c2c6", "dba3be", "592454"
  ],
  backgroundColor: [
    "b6e3f4", "c0aede", "d1d4f9", "ffd5dc", "ffdfbf", "f0f0f0", "e94560", "transparent"
  ]
};
